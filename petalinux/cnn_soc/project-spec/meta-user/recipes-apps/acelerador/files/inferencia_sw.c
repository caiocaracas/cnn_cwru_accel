                   ...
                   int8_t *sai)
{
    ...
    for (int oc = 0; oc < nof; oc++) {
        ...
        // a tabela tem um valor por camada ou um por canal de saida, na mesma
        // granularidade que o circuito usa
...
#if GAP
    // media global: um peso por canal, reusado em todas as posicoes. A ordem
    // da soma acompanha a do motor da PL, para bater bit a bit; o fator 1/npos
    // e' comum as classes e ja' esta' no bias.
